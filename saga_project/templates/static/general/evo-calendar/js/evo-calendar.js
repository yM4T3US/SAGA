...
;(function(factory) {
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup = '<div class="event-container" id='+(event_data.id)+' role="button" data-event-index="'+(event_data.id)+'">';
        ...
        if (event_data.badge) markup += '<span data-scheduled="'+event_data.status+'" data-student-id="null" data-student-name="null" id="'+event_data.id+'"  class="get-username">'+event_data.badge+'</span>';
        markup += '</p>'
